...
class AuthorizeNetSIM extends ExternalPayment
{
	public function getUrl()
	{
		...
		$params['x_last_name'] = $this->details->firstName->get();
		...
		$params['x_ship_to_first_name'] = $this->details->firstName->get();
		$params['x_ship_to_last_name'] = $this->details->firstName->get();
		$params['x_ship_to_address'] = $this->details->address->get();
		$params['x_ship_to_city'] = $this->details->city->get();
		$params['x_ship_to_state'] = $this->details->state->get();
		$params['x_ship_to_zip'] = $this->details->postalCode->get();
		$params['x_ship_to_country'] = $this->details->country->get();
