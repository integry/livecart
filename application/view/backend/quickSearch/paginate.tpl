{if $from > 1 || $to < $count}
	<div class="qsPaginate">
		...
		{if $from > 1}
			<a class="qsPrevious" href="javascript:void(0);" onclick="Backend.QuickSearch.previous(this, '{$class}');">&lt;&lt;&lt;</a>
		{else}
		...
		{if $to < $count}
			<a class="qsNext" href="javascript:void(0);" onclick="Backend.QuickSearch.next(this, '{$class}');">&gt;&gt;&gt;</a>
		{else}
