...
<div id="productManagerContainer" class="managerContainer" style="display: none;">
	...
	<div class="tabContainer">
		<ul class="tabList tabs">
			<li id="productBasic" class="tab active"><a href="{link       controller=backend.product action=basic           id=_id_}?categoryID=_categoryID_}">Basic data</a><span> </span></li>
			...
			<li id="productImages" class="tab inactive"><a href="{link    controller=backend.product action=images          id=_id_}?categoryID=_categoryID_">Images</a><span> </span></li>
			<li id="productRelated" class="tab inactive"><a href="{link   controller=backend.product action=relatedProducts id=_id_}?categoryID=_categoryID_">Related products</a><span> </span></li>
			...
			<li id="productDiscounts" class="tab inactive"><a href="{link controller=backend.product action=discounts       id=_id_}?categoryID=_categoryID_">Discounts</a><span> </span></li>
			<li id="productFiles" class="tab inactive"><a href="{link     controller=backend.product action=files           id=_id_}?categoryID=_categoryID_">Files</a><span> </span></li>
		</ul>
	</div>
