...
//<[!CDATA[
	...
	Backend.ProductOption.prototype.links.mergeValues	 = {/literal}'{link controller=backend.productOptionValue action=mergeValues}/'{literal};
	Backend.ProductOption.prototype.links.deleteValue	 = {/literal}'{link controller=backend.productOptionValue action=delete}/'{literal};
	Backend.ProductOption.prototype.links.sortValues	  = {/literal}'{link controller=backend.productOptionValue action=sort}/'{literal};
...
{* No group *}
<ul id="productOption_items_list_{$parentID}_" class="productOptionList {allowed role="category.update"}activeList_add_sort activeList_add_delete{/allowed} activeList_add_edit activeList_accept_productOptionList">
