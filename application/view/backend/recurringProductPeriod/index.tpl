...
<fieldset style="display: none;" class="addForm rpp_new_form" id="rpp_new_form_{$product.ID}">
	...
	{include file="backend/recurringProductPeriod/form.tpl" recurringProductPeriod=$newRecurringProductPeriod form=$newForm}
</fieldset>
...
<script type="text/javascript">
	ActiveList.prototype.getInstance("recurringProductPeriods_{$recurringProductPeriods.0.productID}",
	...
	Backend.RecurringProductPeriod.prototype.properties = {literal}{{/literal}
		...
		link_edit: "{link controller=backend.recurringProductPeriod action=edit id=1111111111}",
		link_remove: "{link controller=backend.recurringProductPeriod action=delete id=1111111111}",
