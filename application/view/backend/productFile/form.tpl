<div class="productFile_form"  style="display: none;">
	<form action="[[ url("backend.productFile/update") ]]" method="post" target="productFileUploadIFrame_" enctype="multipart/form-data" {denied role="product.update"}class="formReadonly"{/denied}>
		<fieldset>
