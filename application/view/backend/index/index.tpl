...
<fieldset>
	...
	<select id="period" onchange="jQuery('#count').html(''); new LiveCart.AjaxUpdater('[[ url("backend.index/totalOrders") ]]?period=' + this.value, $('count'), $('periodProgress'));">
	...
	<span class="orderStat"><a href="[[ url("backend.customerOrder") ]]#group_3#tabOrders__">{t _status_new}</a>:</span>
	<span class="statCount">[[orderCount.new]]</span>
	<span class="sep"> | </span>

	<span class="orderStat"><a href="[[ url("backend.customerOrder") ]]#group_4#tabOrders__">{t _status_processing}</a>:</span>
