{form handle=$pricingForm action="controller=backend.productPrice action=save id=product_form_`$product.ID`_`$product.Category.ID`" method="POST" onsubmit="Backend.Product.saveForm(this); return false;" onreset="Backend.Product.resetAddForm(this);"}
