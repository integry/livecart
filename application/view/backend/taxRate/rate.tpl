{form id="taxRate_`$taxRate.DeliveryZone.ID`_`$taxRate.ID`" handle=$form action="controller=backend.taxRate action=save id=`$taxRate.ID`" method="post" onsubmit="Backend.DeliveryZone.TaxRate.prototype.getInstance(this).save(); return false;" method="POST"}
