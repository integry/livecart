<h1><ins>TODO: complete when the updater functionality has been finished</ins></h1>
...
<br \><br \>
<h3 id="set_base">Set the Base / Dafault? Currency</h3>
...
<br /><br /><ins>enter product prices in other currencies</ins> <br /><br />

If you wish to change the base currency click the <strong>Set as base currency</strong> link under the currency name.</p>
...
one United Kingdom Pound is worth 1.96475 US Dollars, enter this value and click <strong>Save</strong> to set 
the rates. </p>
...
left of the currency name. Clear the mark to disable it.</p>
