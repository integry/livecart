<div class="tree ui-widget-content">
	<ul
		...
		<li ya-tree="child in data.children at ul" class="minimized-{{child.open != true}}">
			<div ng-click="tree.select(child)" ng-init="mouseover=0" ng-mouseover="mouseover=1" ng-mouseout="mouseover=0" ng-class="{ldelim}'ui-state-hover': mouseover, 'ui-state-active': tree.selectedID == child.id{rdelim}">
