...
<ul>	
	<li><a href="{self}#view_sort">View and Sort Users</a></li>
	<li><a href="{self}#find">Find users</a></li>
...
<p>You can sort users ascending or descending by clicking the arrow next to appropriate attribute:</p>
...
<ol>
	...
	<img src="image/doc/users/select_users.bmp">
...
<ins>Add some users to your group (...)</ins>
