...
<p>You can set image sizes for products and categories. According to preset image sizes, all the uploaded images will be resized accordingly. You can preset four types of images: small, thumbnail, medium and large.</p>
<ins>where are each of them used?</ins>
...
<ul>
	...
	<li>Price filters are static thus you have to create the same filter's criteria for all categories:</li>
	<img src="image/doc/settings/criterion.bmp"/>
	<ul>
		<li>Filter Name - the name of the criterion (for example, "100 to 199")</li>
		<li>Price From - the bottom line of the price (100).</li>
		<li>Price To - the max price value - (199).</li>
	</ul>
	<li>Translate - click on the language tab to enter filter's criteria names.</li>
</ul>


<h3 id="inventory">Inventory</h3>

<p>This section is used for setting inventory parameters.</p>

<ul>
	<li>Disable inventory tracking - inventory tracking is used (...)</li>
	<li>Disable products that are out of stock - mark the checkbox to show products that are out of stock.</li>
</ul>
...
<ul>
	<li>Minimum order total - the minimum amount of total price per order.</li>
...
<ul>	
	<li>Require customers to enter phone number on registration - </li>
</ul>
...
<p>Enabled countries are available for delivery zones, etc <strong>(?)</strong> </p>