...
<ol>
	<li>Turn on the "Live customization mode":</li>
	<img src="image/doc/customize/live/on.bmp">
	<li>Go to your store's frontend:</li>
	<img src="image/doc/customize/live/go.bmp">
	<p>When the customization mode is on, you will notice how moving your mouse cursor affects distinct areas of your store's website. These are the chunks / parts of the the web site and each of them is controlled by a particular template. To modify a part of your web site you have to edit appropriate template.</p> 
...
<h3 id="translate">Translate user interface</h3>
<p>To start using "Live Translation" mode:</p>

<ol>
	<li>Turn on the Live translation:</li>
	<img src="image/doc/customize/live/on.bmp">
	<li>Go to your store's frontend:</li>
	<img src="image/doc/customize/live/go.bmp">
