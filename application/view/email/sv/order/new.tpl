...
Tack för din order till {'STORE_NAME'|config}. Om du behöver kontakta oss angående din order var god uppge ditt order ID <b class="orderID">#{$order.invoiceNumber}</b>.
