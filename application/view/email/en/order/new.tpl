...
Thank you for your order, which you just placed at {'STORE_NAME'|config}. If you need to contact us regarding this order, please quote the order ID <b class="orderID">#{$order.invoiceNumber}</b>.
