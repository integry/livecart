...
Terima kasih atas order Anda, yang baru saja Anda buat di {'STORE_NAME'|config}. Jika Anda hendak menghubungi kami terkait dengan order ini, mohon cantumkan nomor order: <b class="orderID">#{$order.invoiceNumber}</b>.
