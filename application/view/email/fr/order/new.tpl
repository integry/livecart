...
Merci pour votre commande, Que vous venez tout juste de place sur {'STORE_NAME'|config}. Si vous avez besoin de nous contacter a propos de cette commande, s.v.p indiquer l'identifiant (ID) de la commande #{$order.ID}.
