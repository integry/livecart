...
มีการปรับเปลี่ยนสถานะของใบสั่งซื้อเลขที่ <b class="orderID">#{$order.ID}</b>ของคุณแล้ว
{else}
สถานะได้ถูกอัพเดทความคืบหน้าในการจัดการสินค้าของคุณจากใบสั่งซื้อเลขที่ <b class="orderID">#{$order.ID}</b>.
{/if}
