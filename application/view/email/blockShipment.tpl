...
{% if $SHOW_SKU %}{$item.Product.sku|@str_pad_iconv:10}{% endif %}{$item.Product.name_lang|truncate:29:"...":"true"|@str_pad_iconv:31}{$item.formattedDisplayPrice|truncate:9:"..."|@str_pad:10}{$item.count|truncate:8:"..."|@str_pad:9}[[item.formattedDisplaySubTotal]]
{% if $item.options %}
