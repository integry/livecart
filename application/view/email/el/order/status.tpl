{'STORE_NAME'|config} Ενημέρωση Καταλόγου Παραγγελλίας
Αγαπητέ/ή {$user.fullName},

{if $order.shipments|@count == 1}
Ο Κατάλογος ενημερώθηκε για την παραγγελλία σας <b class="orderID">#{$order.ID}</b>.
{else}
Ο Κατάλογος έχει ενημερωθεί για μία ή περισσότερες αποστολές από την παραγγελλία σας <b class="orderID">#{$order.ID}</b>.
{/if}
