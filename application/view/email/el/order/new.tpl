...
Ευχαρισθούμε για την παραγγελλία σας που δόθηκε στο {'STORE_NAME'|config}. Εάν χρειασθεί να επικοινωνήσετε μαζί μας σχετικά με αυτή την παραγγελλία,παρακαλούμε αναφέρατε τον κωδικό(ID) αυτής <b class="orderID">#{$order.ID}</b>.
