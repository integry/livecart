...
class LiveCartRenderer extends SmartyRenderer
{
	...
	public function __construct(LiveCart $application)
	{
		...
		$this->registerHelperDirectory($this->config->getPath('application/helper/smarty'));
		$this->registerHelperDirectory($this->config->getPath('application/helper/smarty/form'));
	...
	public function getThemeList()
	{
		...
		$otherThemes = array();
		foreach (array($this->config->getPath('application/view/theme'), $this->config->getPath('storage/customize/view.theme')) as $themeDir)
		{
