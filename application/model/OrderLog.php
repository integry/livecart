...
{     
	...
	public static function getNewInstance(OrderHistory $orderHistory, $type, $action, $oldValue, $newValue)	
	{
        $instance = parent::getNewInstance(__CLASS__);
        
		$instance->user->set($orderHistory->getUser());   
        ...
        $instance->oldTotal->set($orderHistory->getOldOrder->totalAmount->get());
        $instance->newTotal->set($orderHistory->getCurrentOrder->totalAmount->get());
