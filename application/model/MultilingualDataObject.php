...
abstract class MultilingualDataObject extends ActiveRecordModel {
	...
	protected static function getLangDataRecordSet($className, ARSelectQueryBuilder $query, $recordIDList = array()) {
		...
		$langDataQuery->getFilter()->mergeCondition(new EqualsCond(new ARFieldHandle($className, $langDataJoinField->getForeignFieldName()), 
																   new ARFieldHandle(self::getLanguageDataObjectName($className), $langDataJoinField->getName())));
