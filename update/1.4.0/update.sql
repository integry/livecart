...
ALTER TABLE Product DROP FOREIGN KEY ShippingClass_Product;

ALTER TABLE Product DROP FOREIGN KEY TaxClass_Product;
...
ALTER TABLE TaxRate DROP FOREIGN KEY TaxClass_TaxRate;
...
ALTER TABLE StaticPage DROP FOREIGN KEY StaticPage_StaticPage;
...
ALTER TABLE CategoryPresentation DROP FOREIGN KEY Product_CategoryPresentation;
...
ALTER TABLE SessionData DROP FOREIGN KEY User_SessionData;

ALTER TABLE OrderedFile DROP FOREIGN KEY OrderedItem_OrderedFile;

ALTER TABLE OrderedFile DROP FOREIGN KEY ProductFile_OrderedFile;

ALTER TABLE CategoryRelationship DROP FOREIGN KEY Category_CategoryRelationship;

ALTER TABLE CategoryRelationship DROP FOREIGN KEY Category_CategoryRelationship2;

# ---------------------------------------------------------------------- #
# Modify table "DeliveryZone"                                            #
# ---------------------------------------------------------------------- #

# Remove autoinc for PK drop #

ALTER TABLE DeliveryZone MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE DeliveryZone ADD COLUMN type INTEGER UNSIGNED NOT NULL;

ALTER TABLE DeliveryZone MODIFY type INTEGER UNSIGNED NOT NULL AFTER position;

ALTER TABLE DeliveryZone MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE ShippingService ADD COLUMN eavObjectID INTEGER UNSIGNED;

ALTER TABLE ShippingService ADD COLUMN description MEDIUMTEXT;

ALTER TABLE ShippingService ADD COLUMN deliveryTimeMinDays INTEGER;

ALTER TABLE ShippingService ADD COLUMN deliveryTimeMaxDays INTEGER;

ALTER TABLE ShippingService MODIFY eavObjectID INTEGER UNSIGNED AFTER deliveryZoneID;
...
ALTER TABLE StaticPage ADD COLUMN eavObjectID INTEGER UNSIGNED;

ALTER TABLE StaticPage ADD COLUMN menu TEXT;

ALTER TABLE StaticPage MODIFY eavObjectID INTEGER UNSIGNED AFTER parentID;

ALTER TABLE StaticPage MODIFY menu TEXT AFTER isInformationBox;
...
ALTER TABLE EavObject ADD COLUMN shippingServiceID INTEGER UNSIGNED;

ALTER TABLE EavObject ADD COLUMN staticPageID INTEGER UNSIGNED;

ALTER TABLE EavObject MODIFY shippingServiceID INTEGER UNSIGNED AFTER transactionID;

ALTER TABLE EavObject MODIFY staticPageID INTEGER UNSIGNED AFTER shippingServiceID;

ALTER TABLE EavObject MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;

# ---------------------------------------------------------------------- #
# Modify table "OrderedFile"                                             #
# ---------------------------------------------------------------------- #

# Remove autoinc for PK drop #

ALTER TABLE OrderedFile MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE OrderedFile MODIFY productFileID INTEGER UNSIGNED;

ALTER TABLE OrderedFile MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;
...
UPDATE StaticPage SET menu='a:2:{s:11:"INFORMATION";b:1;s:15:"ROOT_CATEGORIES";b:0;}' WHERE isInformationBox=1;