...
# Model version:         Version 2010-07-26 5                            #
# From model version:    Version 2009-10-09 1                            #
# ---------------------------------------------------------------------- #
...
ALTER TABLE ProductFile ADD COLUMN allowDownloadCount INTEGER;

ALTER TABLE ProductFile MODIFY allowDownloadCount INTEGER AFTER allowDownloadDays;
...
ALTER TABLE Transaction ADD COLUMN ccCVV VARCHAR(40);

ALTER TABLE Transaction MODIFY ccCVV VARCHAR(40) AFTER ccName;
...
ALTER TABLE StaticPage ADD COLUMN parentID INTEGER UNSIGNED;

ALTER TABLE StaticPage MODIFY parentID INTEGER UNSIGNED AFTER ID;
...
ALTER TABLE DiscountCondition ADD COLUMN isReverse BOOL;

ALTER TABLE DiscountCondition MODIFY isReverse BOOL AFTER isActionCondition;
