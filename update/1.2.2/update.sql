...
ALTER TABLE DiscountCondition ADD COLUMN couponLimitCount INTEGER;

ALTER TABLE DiscountCondition ADD COLUMN couponLimitType TINYINT COMMENT '0 - overall 1 - by user';

ALTER TABLE DiscountCondition MODIFY couponLimitCount INTEGER AFTER couponCode;

ALTER TABLE DiscountCondition MODIFY couponLimitType TINYINT COMMENT '0 - overall 1 - by user' AFTER couponLimitCount;

ALTER TABLE DiscountCondition MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;

# ---------------------------------------------------------------------- #
# Modify table "OrderCoupon"                                             #
# ---------------------------------------------------------------------- #

ALTER TABLE OrderCoupon MODIFY ID INTEGER UNSIGNED ZEROFILL NOT NULL;

ALTER TABLE OrderCoupon ADD COLUMN discountConditionID INTEGER UNSIGNED;

ALTER TABLE OrderCoupon MODIFY discountConditionID INTEGER UNSIGNED AFTER orderID;

ALTER TABLE OrderCoupon MODIFY ID INTEGER UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT;
