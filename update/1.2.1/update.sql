...
DROP INDEX IDX_Product_isEnabled_Category ON Product;

ALTER TABLE Product MODIFY ID INTEGER UNSIGNED NOT NULL COMMENT 'Number of times product has been viewed by customers';

ALTER TABLE Product ADD COLUMN childSettings TEXT COMMENT 'Determines price and shipping weight calculation for child products - whether to add/substract from parent or override completely';

ALTER TABLE Product ADD COLUMN fractionalStep FLOAT;

ALTER TABLE Product MODIFY categoryID INTEGER UNSIGNED COMMENT 'The Category the product belongs to';
...
ALTER TABLE CustomerOrder ADD COLUMN isMultiAddress BOOL NOT NULL;

ALTER TABLE CustomerOrder MODIFY isMultiAddress BOOL NOT NULL AFTER capturedAmount;
...
DROP INDEX IDX_OrderedItem_3 ON OrderedItem;

ALTER TABLE OrderedItem MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE OrderedItem MODIFY isSavedForLater TINYINT COMMENT 'Determines if the product has been added to shopping cart or to a wish list';
...
# ---------------------------------------------------------------------- #
# Modify table "ProductRelationship"                                     #
# ---------------------------------------------------------------------- #
...
ALTER TABLE ProductRelationship ADD COLUMN type INTEGER NOT NULL COMMENT '0 - related product (cross-sell), 1 - up-sell';

ALTER TABLE ProductRelationship CHANGE ProductID productID INTEGER UNSIGNED NOT NULL;
...
ALTER TABLE ProductFile ADD COLUMN filePath TEXT COMMENT 'Local file path or URL';

ALTER TABLE ProductFile MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;

# ---------------------------------------------------------------------- #
# Modify table "ProductRelationshipGroup"                                #
# ---------------------------------------------------------------------- #

ALTER TABLE ProductRelationshipGroup MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE ProductRelationshipGroup ADD COLUMN categoryID INTEGER UNSIGNED;

ALTER TABLE ProductRelationshipGroup ADD COLUMN type INTEGER NOT NULL COMMENT 'see ProductRelationship';

ALTER TABLE ProductRelationshipGroup MODIFY categoryID INTEGER UNSIGNED AFTER ProductID;

ALTER TABLE ProductRelationshipGroup MODIFY type INTEGER NOT NULL COMMENT 'see ProductRelationship' AFTER categoryID;

ALTER TABLE ProductRelationshipGroup MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE Transaction ADD COLUMN serializedData TEXT;
...
ALTER TABLE Shipment ADD COLUMN shippingAddressID INTEGER UNSIGNED;

ALTER TABLE Shipment MODIFY shippingAddressID INTEGER UNSIGNED AFTER shippingServiceID;

ALTER TABLE Shipment MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;

# ---------------------------------------------------------------------- #
# Modify table "ShippingService"                                         #
# ---------------------------------------------------------------------- #

ALTER TABLE ShippingService MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE ShippingService ADD COLUMN isFinal BOOL;

ALTER TABLE ShippingService MODIFY isFinal BOOL AFTER deliveryZoneID;

ALTER TABLE ShippingService MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;

# ---------------------------------------------------------------------- #
# Modify table "ShipmentTax"                                             #
# ---------------------------------------------------------------------- #

ALTER TABLE ShipmentTax MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE ShipmentTax ADD COLUMN type TINYINT COMMENT 'applied to: NULL - total amount (deprecated), 1 - subtotal, 2 - shipping amount';

ALTER TABLE ShipmentTax MODIFY type TINYINT COMMENT 'applied to: NULL - total amount (deprecated), 1 - subtotal, 2 - shipping amount' AFTER shipmentID;

ALTER TABLE ShipmentTax MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE ProductOption ADD COLUMN selectMessage MEDIUMTEXT;

ALTER TABLE ProductOption ADD COLUMN isPriceIncluded BOOL COMMENT 'Include product price when displaying option price (base product price + option choice price = option display price)';

ALTER TABLE ProductOption ADD COLUMN displayType INTEGER COMMENT '0 - select box, 1 - radio buttons';

ALTER TABLE ProductOption MODIFY selectMessage MEDIUMTEXT AFTER description;

ALTER TABLE ProductOption MODIFY isPriceIncluded BOOL COMMENT 'Include product price when displaying option price (base product price + option choice price = option display price)' AFTER isDisplayedInCart;

ALTER TABLE ProductOption MODIFY displayType INTEGER COMMENT '0 - select box, 1 - radio buttons' AFTER isPriceIncluded;

ALTER TABLE ProductOption MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;

# ---------------------------------------------------------------------- #
# Modify table "EavField"                                                #
# ---------------------------------------------------------------------- #

ALTER TABLE EavField MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE EavField ADD COLUMN stringIdentifier CHAR(40);

ALTER TABLE EavField MODIFY stringIdentifier CHAR(40) AFTER classID;

ALTER TABLE EavField MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;

# ---------------------------------------------------------------------- #
# Modify table "EavFieldGroup"                                           #
# ---------------------------------------------------------------------- #

ALTER TABLE EavFieldGroup MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE EavFieldGroup ADD COLUMN stringIdentifier CHAR(40);

ALTER TABLE EavFieldGroup MODIFY stringIdentifier CHAR(40) AFTER classID;

ALTER TABLE EavFieldGroup MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;

# ---------------------------------------------------------------------- #
# Modify table "EavObject"                                               #
# ---------------------------------------------------------------------- #

ALTER TABLE EavObject MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE EavObject ADD COLUMN userAddressID INTEGER UNSIGNED;

ALTER TABLE EavObject ADD COLUMN transactionID INTEGER UNSIGNED;

ALTER TABLE EavObject MODIFY userAddressID INTEGER UNSIGNED AFTER userGroupID;

ALTER TABLE EavObject MODIFY transactionID INTEGER UNSIGNED AFTER userAddressID;

ALTER TABLE EavObject MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE DiscountCondition ADD COLUMN isFinal BOOL NOT NULL;

ALTER TABLE DiscountCondition MODIFY isFinal BOOL NOT NULL AFTER isActionCondition;
...
ALTER TABLE DiscountAction ADD COLUMN discountStep INTEGER;

ALTER TABLE DiscountAction ADD COLUMN discountLimit INTEGER;

ALTER TABLE DiscountAction CHANGE amountMeasure actionType TINYINT NOT NULL;

ALTER TABLE DiscountAction MODIFY discountStep INTEGER AFTER amount;

ALTER TABLE DiscountAction MODIFY discountLimit INTEGER AFTER discountStep;
