...
$sub = "user_" . $_SESSION['User'] . '/';
$base_url="";  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = '/public/upload/files/' . $sub; // path from base_url to base of upload folder (with start and final /)
$current_path = '../upload/files/' . $sub; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../upload/files/thumbs/' . $sub; // relative path from filemanager folder to thumbs folder (with final /)

$fullPath = dirname(dirname(__file__)) . '/' . $current_path;
if (!file_exists($fullPath))
{
	mkdir($fullPath);
}

$_SESSION["subfolder"] ="user_" . $_SESSION['User'];
