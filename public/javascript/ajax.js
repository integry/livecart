...
/**
* Denis added sample.
* @param response_is_string
*/
function http(verb,url,rm,qry,response_is_string) {
...
function popWait(){ 
	...
	if( proc == null ){
		...
		p.id = "JSMX_loading";
		p.innerHTML = "<div style='position: absolute; left:10px; top:10px; height: 25px; width: 100px; background-color: #ff0000; color: #ffffff'>LOADING...</div>";
