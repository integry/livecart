...
Backend.ProductVariation.Editor = function()
{
	this.callConstructor(arguments);
}

Backend.ProductVariation.Editor.methods =
{
	namespace: Backend.ProductVariation.Editor,
	...
	{
		return id ? $("tabProductVariations_" + id + "Content") : $(this.getAddContainerId());
	},
...
Backend.ProductVariation.Editor.inheritsFrom(Backend.MultiInstanceEditor);
