...
("Sekmadienis",
 "Pirmadienis",
 "Antradienis",
 "Tre�iadienisčiadienis",
 "Ketvirtadienis",
 "Pentadienis",
 "Šeštadienis�e�tadienis",
 "Sekmadienis");
...
"- Nuspauskite ir laikykite pelės klavišų greitesniam pasirinkimui.";
Calendar._TT["ABOUT_TIME"] = "\n\n" +
"Laiko pasirinkimas:\n" +
"- Spustelkite ant valandą arba ainui - skačius padidės vienetu.\n" +
"- Jei spausite kartu su Shift, skaičius sumažės.\n" +
"- Greitam pasirinkimui spustelkite ir pajudinkite pelė.";

Calendar._TT["PREV_YEAR"] = "Ankstesni metai (laikykite, jei norite meniu)";
Calendar._TT["PREV_MONTH"] = "Ankstesnis mėnuo (laikykite, jei norite meniu)";
Calendar._TT["GO_TODAY"] = "Pasirinktitė šiandieną";
...
Calendar._TT["SUN_FIRST"] = "Pirma savaitėses es diena - sekmadienis";
