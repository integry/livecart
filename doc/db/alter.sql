...
# Created on:            2008-08-24 23:40                                #
# Model version:         Version 2008-08-24 4                            #
# From model version:    Version 2008-08-24 3                            #
# ---------------------------------------------------------------------- #
...
# ---------------------------------------------------------------------- #
# Modify table "OrderDiscount"                                           #
# ---------------------------------------------------------------------- #

ALTER TABLE OrderDiscount MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE OrderDiscount DROP COLUMN currency;

ALTER TABLE OrderDiscount MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;
