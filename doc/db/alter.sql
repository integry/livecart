...
# Created on:            2008-06-24 23:21                                #
# Model version:         Version 2008-06-24 3                            #
# From model version:    Version 2008-06-24 2                            #
# ---------------------------------------------------------------------- #
...
ALTER TABLE EavField CHANGE eavGroupID eavFieldGroupID INTEGER UNSIGNED COMMENT 'SpecFieldGroup ID if the attribute is being grouped together with other related attributes. If the attribute is not grouped, the value is NULL.';
