...
# Created on:            2008-04-20 22:52                                #
# Model version:         Version 2008-04-20                              #
# From model version:    Version 2008-04-19 2                            #
# ---------------------------------------------------------------------- #
...
# ---------------------------------------------------------------------- #
# Modify table "NewsletterSubscriber"                                    #
# ---------------------------------------------------------------------- #

ALTER TABLE NewsletterSubscriber MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE NewsletterSubscriber MODIFY userID INTEGER UNSIGNED;

ALTER TABLE NewsletterSubscriber MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;
...
ALTER TABLE NewsletterMessage MODIFY status TINYINT NOT NULL DEFAULT 0 COMMENT '0 - not sent 1 - partially sent 2 - sent';

ALTER TABLE NewsletterMessage MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;

# ---------------------------------------------------------------------- #
# Modify table "NewsletterSentMessage"                                   #
# ---------------------------------------------------------------------- #

ALTER TABLE NewsletterSentMessage MODIFY ID INTEGER UNSIGNED NOT NULL;

ALTER TABLE NewsletterSentMessage ADD COLUMN time DATETIME;

ALTER TABLE NewsletterSentMessage MODIFY ID INTEGER UNSIGNED NOT NULL AUTO_INCREMENT;
